    ...
    <div class="w-full mt-2 p-4 bg-gray-700 rounded-lg">
        <form @submit.prevent="edit">
            ...
            <div class="flex flex-col">
                ...
                <input
                    v-model="form.weight.value" type="number" min='0'
                    class="w-full p-2 border rounded text-black outline outline-offset-0 outline-2"
...
<script lang="ts" setup>
    ...
    const form = reactive({
        muscle: { value: props.exercise.attributes.muscle, error: '' },
        name: { value: props.exercise.attributes.name, error: '' },
        sets: { value: props.exercise.attributes.sets, error: '' },
        reps: { value: props.exercise.attributes.reps, error: '' },
        weight: { value: props.exercise.attributes.weight, error: '' },
        rest: { value: props.exercise.attributes.rest, error: '' }
    })
